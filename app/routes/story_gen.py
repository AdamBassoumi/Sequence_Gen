...
OUTPUTS_DIR = Path(settings.OUTPUTS_DIR_PATH)
    ...
    try:
        ...
        with open(prompts_file, "w") as f:
            json.dump(
                {
                    "story_id": story_id,
                    "user_prompt": story_request.prompt,
...
@story_router.get("/story/{story_id}/download")
...
@story_router.get("/story/{story_id}/files")
